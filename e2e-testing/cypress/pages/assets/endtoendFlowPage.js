...
export class EndToEndFlowPage {
    ...
    verifyRenewalConfirmPage(data) {
        ...
        cy.get(this.confirmRegisteringPartyAddress).contains(data.registeringPartyAddress1)
        cy.get(this.confirmRegisteringPartyAddress).contains(data.registeringPartyAddress2)
    ...
    verifyAmendConfirmPage(data) {
       ...
       // cy.get(this.confirmRegisteringPartyAddress).should('have.text', data.confirmRegisteringPartyAddress)
        cy.get(this.confirmRegisteringPartyAddress).contains(data.confirmRegisteringPartyAddress1)
        cy.get(this.confirmRegisteringPartyAddress).contains(data.confirmRegisteringPartyAddress2)
        cy.get(this.folioNumberTitle).should('have.text', data.folioNumberTitle)
        cy.get(this.folioInfo).should('have.text', data.folioInfo)
        cy.get(this.folioTextbox).type(data.folioTextbox)
    ...
    verifySecuredParties(data) {
        ...
        cy.get(this.individualPartyAddress).contains(data.individualPartyAddress1)
        cy.get(this.individualPartyAddress).contains(data.individualPartyAddress2)
        ...
        cy.get(this.individualPartyBusinessAddress).contains(data.individualPartyBusinessAddress1)
        cy.get(this.individualPartyBusinessAddress).contains(data.individualPartyBusinessAddress2)

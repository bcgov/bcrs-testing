...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Excise Tax Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(credentials.type, registrationType.crownCharge.et)
        ...
        securityAgreementPage.verifyCollateralDescription(gcData.collateralDescription.et)

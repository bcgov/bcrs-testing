...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Excise Tax Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(Cypress.env('credentials'), registrationType.crownCharge.et)

        marriageOrSeparationAgreementPage.verifyRegistrationLength(partyData.lengthOfRegistration)

        feeSummaryModalPage.verifyFeeSummaryModal(feeData.feeSummary.et)
        ...
        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.et.description)

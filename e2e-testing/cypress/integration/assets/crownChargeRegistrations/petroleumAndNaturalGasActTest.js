...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Petroleum and Natural Gas Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(Cypress.env('credentials'), registrationType.crownCharge.pg)
        ...
        securityAgreementPage.setGeneralCollateralText(gcData.collateralDescription.pg.description)

        securityAgreementPage.clickReviewAndConfirmButton()

        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.pg.description)

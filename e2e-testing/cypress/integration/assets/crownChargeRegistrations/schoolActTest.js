...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('School Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(Cypress.env('credentials'), registrationType.crownCharge.sc)
        ...
        securityAgreementPage.setGeneralCollateralText(gcData.collateralDescription.sc.description)

        securityAgreementPage.clickReviewAndConfirmButton()

        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.sc.description)

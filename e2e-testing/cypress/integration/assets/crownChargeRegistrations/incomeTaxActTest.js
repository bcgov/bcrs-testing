...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Income Tax Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(Cypress.env('credentials'), registrationType.crownCharge.it)
        ...
        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.it.description)

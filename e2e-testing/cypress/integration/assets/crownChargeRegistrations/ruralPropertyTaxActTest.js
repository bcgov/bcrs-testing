...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Rural Property Tax Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(Cypress.env('credentials'), registrationType.crownCharge.ra)

        marriageOrSeparationAgreementPage.verifyRegistrationLength(partyData.lengthOfRegistration)

        feeSummaryModalPage.verifyFeeSummaryModal(feeData.feeSummary.ra)
        ...
        securityAgreementPage.setGeneralCollateralText(gcData.collateralDescription.ra.description)

        securityAgreementPage.clickReviewAndConfirmButton()

        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.ra.description)

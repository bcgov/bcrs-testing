...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Rural Property Tax Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(credentials.type, registrationType.crownCharge.ra)
        ...
        securityAgreementPage.setGeneralCollateralText(gcData.collateralDescription.ra)

        securityAgreementPage.clickReviewAndConfirmButton()

        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.ra)

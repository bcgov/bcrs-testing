...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Property Transfer Tax Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(Cypress.env('credentials'), registrationType.crownCharge.pt)
        ...
        securityAgreementPage.setGeneralCollateralText(gcData.collateralDescription.pt.description)

        securityAgreementPage.clickReviewAndConfirmButton()

        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.pt.description)

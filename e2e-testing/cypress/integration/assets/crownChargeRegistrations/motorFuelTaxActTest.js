...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Motor Fuel Tax Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(Cypress.env('credentials'), registrationType.crownCharge.ft)
        ...
        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.ft.description)

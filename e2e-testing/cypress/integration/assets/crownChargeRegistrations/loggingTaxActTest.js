...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Logging Tax Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(credentials.type, registrationType.crownCharge.lo)
        ...
        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.lo)

...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Forest Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(Cypress.env('credentials'), registrationType.crownCharge.fo)

        marriageOrSeparationAgreementPage.verifyRegistrationLength(partyData.lengthOfRegistration)

        feeSummaryModalPage.verifyFeeSummaryModal(feeData.feeSummary.fo)
        ...
        securityAgreementPage.setGeneralCollateralText(gcData.collateralDescription.fo.description)
        
        securityAgreementPage.clickReviewAndConfirmButton()

        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.fo.description)

...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Forest Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(credentials.type, registrationType.crownCharge.fo)
        ...
        securityAgreementPage.setGeneralCollateralText(gcData.collateralDescription.fo)
        
        securityAgreementPage.clickReviewAndConfirmButton()

        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.fo)

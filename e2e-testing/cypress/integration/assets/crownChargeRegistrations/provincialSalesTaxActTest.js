...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Provincial Sales Tax Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(credentials.type, registrationType.crownCharge.ps)
        ...
        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.ps)

...
describe('Crown Charge Registrations Test Suite ', function () {
    ...
    it('Mineral Land Tax Act Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(credentials.type, registrationType.crownCharge.md)
        ...
        securityAgreementPage.setGeneralCollateralText(gcData.collateralDescription.md)

        securityAgreementPage.clickReviewAndConfirmButton()

        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.md)

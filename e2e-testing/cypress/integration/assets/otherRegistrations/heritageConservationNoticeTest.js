...
describe('PPR Dashboard test Suite ', function () {
    ...
    it('Security Agreement Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(credentials.type, registrationType.other.hn)
        ...
        securityAgreementPage.setGeneralCollateralText(gcData.collateralDescription.hn)

        securityAgreementPage.clickReviewAndConfirmButton()

        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.hn)

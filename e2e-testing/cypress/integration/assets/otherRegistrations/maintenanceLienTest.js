...
describe('Other Registrations Test Suite ', function () {
    ...
    it('Maintenance Lien Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(Cypress.env('credentials'), registrationType.other.ml)

        marriageOrSeparationAgreementPage.verifyRegistrationLength(partyData.lengthOfRegistration)

        feeSummaryModalPage.verifyFeeSummaryModal(feeData.feeSummary.ml)
        ...
        securityAgreementPage.setGeneralCollateralText(gcData.collateralDescription.ml.description)

        securityAgreementPage.clickReviewAndConfirmButton()

        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.ml.description)

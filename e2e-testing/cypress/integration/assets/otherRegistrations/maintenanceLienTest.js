...
describe('Other Registrations Test Suite ', function () {
    ...
    it('Maintenance Lien Test Case', function () {
        ...
        addSecurityAgreementPage.selectStandardRegistrations(credentials.type, registrationType.other.ml)
        ...
        securityAgreementPage.setGeneralCollateralText(gcData.collateralDescription.ml)

        securityAgreementPage.clickReviewAndConfirmButton()

        securityAgreementPage.verifyGeneralCollateral(gcData.collateralDescription.ml)

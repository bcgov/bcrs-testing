...
describe('PPR Dashboard test Suite ', function () {
    ...
    it('Security Agreement Test Case', function () {
        ...
        addSecurityAgreementPage.clickSecurityAgreement()

        //securityAgreementPage.clickRegistrationLengthRadioButton()

        securityAgreementPage.setLengthInYearsTextField(partyData.LengthInYears)
        ...
        // securityAgreementPage.setPartyAddressCity(partyData.PartyCity)

        // securityAgreementPage.setPartyAddressRegion(partyData.PartyRegion)

        // securityAgreementPage.setPartyAddressPostalCode(partyData.PartyPostalCode)
        ...
        //securityAgreementPage.clickDebtorAddressCountry()
        ...
        securityAgreementPage.setGeneralCollateralText(collateralData.GeneralCollateral)
